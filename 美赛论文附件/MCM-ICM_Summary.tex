...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Replace YZ in the next line with your chosen problem
% and replace 1111111 with your Team Control Number
\newcommand{\Problem}{YZ}
...
\end{document}
\end
$RVR = \frac{\beta_0 + \beta_1Make + \beta_2Variant + ... + \beta_5Country\_Region\_State+ \Omega}{ARIMA(Country\_Region\_State,year)}$ 